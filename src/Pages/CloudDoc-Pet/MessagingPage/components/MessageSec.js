      ...
      <div className="messageSec">
        <div className="flexBetweenCenter header">
          <div className="userItem" style={{ height: "100%" }}>
            <img src="/images/CloudDoc-Pat/profileM1.png" className="profileImg"></img>
            <div>
          ...
          <div className="moreIconDiv">
            <img
              src="/images/CloudDoc-Pat/moreIcon.png"
          ...
          <div className="sendDiv">
            <div className="attachmentDiv">
              <img
                ...
                src="/images/CloudDoc-Pat/attach.svg"
                style={{ width: "100%" }}
                alt="icon"
              ></img>
            </div>
            ...
            <div className="sendIconDiv">
              <img
                ...
                src="/images/CloudDoc-Pat/send.svg"
                style={{ width: "100%" }}
                alt="icon"
              ></img>
            </div>
...
const MessageDiv = ({ id, message }) => {
  return (
    <div className={id === "1" ? "messageDiv myMessage" : "messageDiv "}>
      <img src="/images/CloudDoc-Pat/profileM2.png" className="msgImg"></img>
