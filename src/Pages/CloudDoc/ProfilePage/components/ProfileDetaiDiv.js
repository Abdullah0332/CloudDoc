      ...
      <div className="col-md-8">
        <div className="header">
          ...
          <div className="nameSec ml-3">
            ...
            <div className="tabSec d-none d-md-flex">
              <div className="tab">
                <img className="icon" src="/images/CloudDoc/inPerson.png"></img>
                <span>In-person visits</span>
              </div>
              <div className="tab">
                <img className="icon" src="/images/CloudDoc/videoChat.png"></img>
        ...
        <div className="detailTabSec">
          <div className="detailTab">
            <img className="icon mt-1" src="/images/CloudDoc/done.svg"></img>
            <div className="ml-3">
          ...
          <div className="detailTab">
            <img className="icon mt-1" src="/images/CloudDoc/clock.svg"></img>
            <div className="ml-3">
          ...
          <div className="detailTab">
            <img className="icon mt-1" src="/images/CloudDoc/lamp.svg"></img>
            <div className="ml-3">
            ...
            <div>
              ...
              <div className="reviewDateDiv">
                ...
                <span className="flexCenter ml-2">
                  <img className="videoIcon" src="/images/CloudDoc/videoChat.png"></img>
                  <span>Video visit</span>
                </span>
              </div>
            </div>
