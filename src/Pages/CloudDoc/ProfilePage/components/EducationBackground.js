    ...
    <div className="educationSec w-100">
      ...
      <div className="flexBetweenCenter eduFlex">
        <div className="eduCard">
          ...
          <img src="/images/CloudDoc/medal.svg" className="img"></img>
        </div>
        <div className="eduCard">
          ...
          <img src="/images/CloudDoc/practice.svg" className="img"></img>
        </div>
        <div className="eduCard">
          ...
          <img src="/images/CloudDoc/hospitalEdu.svg" className="img"></img>
        </div>
        <div className="eduCard">
          ...
          <img src="/images/CloudDoc/quality.svg" className="img"></img>
        </div>
      </div>
      ...
      <div className="eduAndTrain educationBg">
        <div className="centerDiv">
          <div className="flexCenter">
            <img src="/images/CloudDoc/eduCap.svg" alt="edu"></img>
      ...
      <div className="flexBetweenCenter mt-3">
        <div className="eduCard eduCard2">
          ...
          <img src="/images/CloudDoc/language.svg" className="img"></img>
        </div>
        <div className="eduCard eduCard2">
          <div className="title">NPI number</div>
          <div className="text">1730527375</div>
          <img src="/images/CloudDoc/eduNumber.svg" className="img"></img>
        </div>
      </div>
    </div>
  );
