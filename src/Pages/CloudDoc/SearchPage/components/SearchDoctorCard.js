        ...
        <div className="searchDoctorCard">
          <div className=" header">
            <div className="flexCenter">
              <img
                src="/images/CloudDoc/searchProfile.png"
              ...
              <div className="">
                ...
                <div className="flexCenter skillFlex">
                  <div className="skill">
                    <img src="/images/CloudDoc/clock.svg" className="icon"></img>
                    <div>
                  ...
                  <div className="skill">
                    <img src="/images/CloudDoc/lamp.svg" className="icon"></img>
                    <div>
                  ...
                  <div className="skill">
                    <img src="/images/CloudDoc/done.svg" className="icon"></img>
                    <div>
            ...
            <div className="btnSec">
              <button className="primaryBtn btnVideo">
                Video Consultation
              </button>
              <button className="primaryBtn btnBook mt-3">
                Book Appointment
              </button>
            </div>
          </div>
          <div className="textBg">
            “Very good. I felt like I was speaking with a friend and not a
            doctor but a very insightful friend.”
          </div>
          <div className="flexCenter">
            <div className="presentDiv">
              <div className="flexCenter alignStart flexNowrap  mb-3">
                <img src="/images/CloudDoc/placeholder.svg" className="icon"></img>
