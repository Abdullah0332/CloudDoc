    ...
    <div className="footerBg">
      <div className="basicLandingRow footer footerPadding">
        <div className="footerFlex">
          <div className="footerItem">
            <img
              className="logo"
              src="/images/CloudDoc/logoBlue.png"
              alt="footerLogo"
            ></img>
            <div className="text">
      ...
      <div className="copyRightDiv">
        ...
        <div className="flexCenter">
          <img
            src="/images/CloudDoc/fb.png"
            alt="social"
            className="socialImg socialFb"
          ></img>
          <img
            src="/images/CloudDoc/twitter.png"
            alt="social"
            className="socialImg"
          ></img>
          <img src="/images/CloudDoc/insta.png" alt="social" className="socialImg"></img>
        </div>
      </div>
    </div>
  );
